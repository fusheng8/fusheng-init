...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'admin', 1, '超管', 0, NULL, '2024-01-30 16:47:28', NULL, '2024-01-30 16:47:21');
INSERT INTO `sys_role` VALUES (2, '用户', 'user', 1, '用户', 0, NULL, '2024-01-30 16:47:31', NULL, NULL);
...
CREATE TABLE `sys_user`  (
  ...
  `role` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '[]' COMMENT '角色',
  ...
  `update_by` bigint NULL DEFAULT NULL COMMENT '更新者',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2023 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'https://img1.baidu.com/it/u=2231549623,3237765525&fm=253&fmt=auto&app=138&f=JPEG?w=501&h=500', 'admin', '677019466004860b4386cb0756a4f328', 'admin', '123456@qq.com', '13112124545', '[1]', 1, 0, '2024-01-29 14:39:02', NULL, '2024-01-29 14:39:02', NULL);
INSERT INTO `sys_user` VALUES (2, 'https://fs-im-kefu.7moor-fs1.com/29397395/4d2c3f00-7d4c-11e5-af15-41bf63ae4ea0/1706622232347/file.png', 'user', '677019466004860b4386cb0756a4f328', 'user', '123456@qq.com	13112124545', '13112124545', '[2]', 1, 0, '2024-01-29 14:39:02', NULL, '2024-01-29 14:39:02', NULL);
